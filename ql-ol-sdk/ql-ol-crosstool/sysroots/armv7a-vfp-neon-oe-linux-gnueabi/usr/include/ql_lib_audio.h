 ...
 * Zichar.zhang         22/10/2018        Change name ql_audio.h -> ql_lib_audio.h
 ****************************************************************************/
#ifndef __QL_LIB_AUDIO_H__
#define __QL_LIB_AUDIO_H__
...
typedef int (*__cb_data)(int hdl, char *buf, int len);
 ...
 *      Fail:    -1.
 */
int Ql_AudRecorder_HStartRecord(int hdl, int format, void *param);
