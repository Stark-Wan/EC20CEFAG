...
typedef enum icalvalue_kind {
   ICAL_ANY_VALUE=5000,
    ICAL_STRING_VALUE=5001,
    ICAL_CALADDRESS_VALUE=5002,
    ICAL_FLOAT_VALUE=5003,
    ICAL_TEXT_VALUE=5004,
    ...
    ICAL_QUERYLEVEL_VALUE=5016,
    ICAL_REQUESTSTATUS_VALUE=5017,
    ICAL_DATETIMEPERIOD_VALUE=5018,
    ICAL_UTCOFFSET_VALUE=5019,
    ICAL_ACTION_VALUE=5020,
    ICAL_METHOD_VALUE=5021,
    ICAL_DATE_VALUE=5022,
    ICAL_CARLEVEL_VALUE=5023,
    ICAL_QUERY_VALUE=5024,
    ICAL_RECUR_VALUE=5025,
    ICAL_XLICCLASS_VALUE=5026,
