...
sub import {
    ...
    foreach my $param ( '/home/q/anisa_nvme/anisa_test/Qualcomm/MDM9x07/OpenLinux/LE.1.0.c3/Customers/R06_b1_BYD/apps_proc/oe-core/build/tmp-glibc/sysroots/mdm9607-perf/usr/include/sys/param.h' ){
      if (open($param, '<', $param)) {
	local ($_, $.);
	while (<$param>) {
