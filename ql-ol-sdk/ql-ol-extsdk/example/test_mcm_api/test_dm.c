...
static void ql_dm_rx_ind_msg_cb(dm_client_handle_type       h_dm,
                                 ...
                                 void                        *contextPtr)
{
    switch(e_msg_id)
    {
    case E_QL_MCM_DM_RADIO_MODE_CHANGED_EVENT:
        {
            char *mode[] = {"unknown", "ON", "OFF", "NotAvailable"};
            E_QL_MCM_DM_AIRPLANE_MODE_TYPE_T *pe_type = (E_QL_MCM_DM_AIRPLANE_MODE_TYPE_T *)pv_data;
            printf("### airplane mode changed to %s ###\n", mode[*pe_type]);
        }
        break;
    default:
        break;
...
static int test_dm(void)
{
    ...
    while(1)
    {
        ...
        case 1://"QL_MCM_DM_AddRxIndMsgHandler"
        {
            ret = QL_MCM_DM_AddRxIndMsgHandler(ql_dm_rx_ind_msg_cb, &h_dm);
            printf("QL_MCM_DM_AddRxIndMsgHandler ret = %d\n", ret);
            break;
        }
        
        case 2://"QL_MCM_DM_SetAirplaneModeChgInd"
        {
            int onoff = 0;
        ...
        case 3://"QL_MCM_DM_GetAirplaneMode"
        {
        ...
        case 4://"QL_MCM_DM_SetAirplaneMode"
        {
            E_QL_MCM_DM_AIRPLANE_MODE_TYPE_T e_airplane_mode;
        ...
        case 5://"QL_MCM_DM_Client_Deinit"
        {
        ...
        case 6://"QL_MCM_DM_GetSerialNumbers"
        {
