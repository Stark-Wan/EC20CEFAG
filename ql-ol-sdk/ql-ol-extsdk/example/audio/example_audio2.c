 ...
 *
 * @Note:
 *      if compiler can't find head file ql_lib_audio.h, please try this:
 *      cp ql-ol-crosstool/sysroots/armv7a-vfp-neon-oe-linux-gnueabi/usr/include/ql_audio.h ql-ol-extsdk/include/ql_lib_audio.h
 *      
 */
